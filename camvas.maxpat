{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "outlettype": [ "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 49.0, 61.0, 36.0, 36.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 32.0, 109.0, 384.0, 247.0 ],
                    "sync": 1
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 32.0, 43.0, 384.0, 313.0 ],
                    "proportion": 0.5
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 44.0, 109.0, 166.0, 22.0 ],
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 53.5, 132.0, 41.5, 132.0 ],
                    "source": [ "obj-64", 0 ]
                }
            }
        ],
        ...
        "boxgroups": [
            {
                "boxes": [ "obj-73", "obj-59", "obj-14", "obj-64" ]
            }
        ],
